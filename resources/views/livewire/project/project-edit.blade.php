    ...
    <form class="w-full max-w-lg bg-white p-6 rounded shadow-md" wire:submit.prevent="save">
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="flex flex-wrap w-full">
                ...
                <input
                    ...
                    id="grid-first-name" type="text" wire:model="name">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="flex flex-wrap w-full">
                ...
                <textarea
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                    id="grid-first-name" wire:model="description"></textarea>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="flex flex-wrap w-full">
                ...
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                    id="grid-first-name" type="date" wire:model="start_date">
            ...
            <div class="flex-wrap flex w-full">
                ...
                <input
                    ...
                    id="grid-first-name" type="date" wire:model="end_date">
